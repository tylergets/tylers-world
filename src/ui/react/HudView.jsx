...
const PROMPTS = [['here', 'here'], ['zone', 'floor'], ['item', 'take'], ['plant', 'tend'], ['furniture', 'use'], ['mailbox', 'mail'], ['tool', 'use'], ['fixture', 'use'], ['npc', 'talk'], ['errand', 'errand'], ['portal', ''], ['note', '']];
...
function Keymap({ open }) { return <div className="hud hud-bl" hidden={!open}><div className="keys"><b>WASD</b><span>Move <span className="dim">or arrows</span></span><b>Shift</b><span>Run</span><b>Click</b><span>Choose action <span className="dim">· right-click ground for menu</span></span><b>Tab</b><span>Switch view</span><b>, .</b><span>Turn camera <span className="dim">snaps in 2D</span></span><b>E</b><span>Talk <span className="dim">·</span> pick up <span className="dim">·</span> enter</span><b>Q</b><span>Drop</span><b>F</b><span>Use tool <span className="dim">·</span> the row above says what</span><b>[ ]</b><span>Change tool</span><b>B</b><span>Open bag</span><b>G</b><span>Wardrobe</span><b>K</b><span>Hide this keymap</span><b>Esc</b><span>Cancel action</span></div></div>; }
